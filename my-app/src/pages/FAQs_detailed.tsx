						...
						<div className='col-12'>
							...
							<div id='accordion'>
								...
								>
									...
									>
										<div className='card-body'>
											Мы принимаем безналичную форму оплаты. Оплата производится
											по счетам, выставленным нашими сотрудниками клиентам.
											Доступные способы оплаты можете узнать{' '}
											<a href='/company/payment'>тут</a>.
										</div>
									</div>
								</div>
								<div
