...
const products: Product[] = [
	...
	},
	{
		...
		title:
			'ТЕРМОМЕТР биметаллический 100мм, Тип - БТ-51.211, осевое присоединение. В комплекте с защитной гильзой (латунь). 0-160С. Резьба G1/2. Длина штока 100мм. Класс точности 1,5.',
		price: '5 050 ₸',
		description: 'kaligrafi/yasin.html',
	},
]
