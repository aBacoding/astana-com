				...
				>
					<div className='row'>
						...
						<div className='col-12'>
							...
							<a href='/catalog/schneider-electric/iem3255'>iEM3255</a>
						</div>
					</div>
				</div>
			</div>
							...
							<div className='col-md-7'>
								...
								>
									<div className='carousel-inner'>
										...
										>
											<img
												src='../../img/schneider/iem3255-1.png'
										...
										<div className='carousel-item' data-bs-interval='4000'>
											<img
												src='../../img/schneider/iem3255-2.jpg'
												className='d-block w-100'
												alt='...'
											/>
										</div>
										<div className='carousel-item' data-bs-interval='4000'>
											<img
												src='../../img/schneider/iem3255-3.jpg'
												className='d-block w-100'
												alt='...'
											/>
										</div>
							...
							<div className='col-md-5'>
								<div className='card-body'>
									<h5 className='card-title details-prod'>
										Счетчик 3-ф актив.-реакт. iEM3255, 4 тарифа, RS-485, кл.
										точн. 0.5S, транс. вкл.
									</h5>
									<p className='card-text det'>
										<span className='text-muted'>169 200 ₸</span>
									</p>
									<div className='card'>
										...
										<div className='card-body'>
											...
											<a
												href='https://api.whatsapp.com/send?phone=+77077790150&text=Добрый%20День!%20Запрос%20счета%20на%20оплату:%20Счетчик%203-ф%20Schneider%20Electric%20iEM3255.'
							...
							<div className='row border g-0 rounded shadow-sm'>
								<div className='col m-4'>
									...
									<p style={{ fontWeight: 'normal', color: '#000000' }}>
										...
										<ul>
											<li>
												Класс точности измерения активной энергии: 0,5S (модели
												iEM3200)
											</li>
